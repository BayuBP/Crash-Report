...
void loop() {
  ...
  if (s.available()>0)
  {
    ...
    if (s.find('D')) hori2 = s.parseFloat();
    if (s.find('E')) veri2 = s.parseFloat();
    if (s.find('F')) jungkir2 = s.parseFloat();
    if (s.find('G')) hori3 = s.parseFloat();
    if (s.find('H')) veri3 = s.parseFloat();
    if (s.find('I')) jungkir3 = s.parseFloat();
    if (s.find('J')) data = s.parseInt();
    Serial.println(data);
    nilai += hori1;
    nilai += "_Y1_";
    nilai += veri1;
